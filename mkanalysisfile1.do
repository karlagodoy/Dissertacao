...
cd "H:\Admin\Students\Godoy_Karla\"
log using mkanalysisfile1.log, replace
/*
...
gen cdt=0
replace cdt=1 if mission=="MISUSCA"
...
*results
reg crimerate i.year i.miss male_personnel if numpersonnel>25 & cdt==1
reg victimrate i.year i.miss male_personnel if numpersonnel>25
reg criminalrate i.year i.miss male_personnel if numpersonnel>25

reg crimerate post i.miss male_personnel if numpersonnel>25
reg victimrate post i.miss male_personnel if numpersonnel>25
reg criminalrate post i.miss male_personnel if numpersonnel>25

reg crimerate i.year male_personnel if mission=="MONUSCO"
