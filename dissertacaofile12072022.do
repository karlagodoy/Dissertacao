...
gen logcrimerate = log(crimerate)

gen logvictimrate = log(victimrate)

gen logcriminalrate = log(criminalrate)
...
* Heterocedasticidade test

reg logcrimerate i.year i.miss male_personnel if numpersonnel>25 & cdt==1
hettest

reg logvictimrate i.year i.miss male_personnel if numpersonnel>25 & cdt==1
hettest

reg logcriminalrate i.year i.miss male_personnel if numpersonnel>25 & cdt==1
hettest

imtest, white

*Logvictimrate is still heterecedastico. 

*Normality tests for Time series data
...
tsset miss yearmo
prais crimerate post i.miss male_personnel if numpersonnel>25

* Comparing post 2019 to the years before. 

prais reg logcrimerate post i.miss male_personnel if numpersonnel>25 & cdt==1
prais reg logvictimrate post i.miss male_personnel if numpersonnel>25 & cdt==1
prais reg logcriminalrate post i.miss male_personnel if numpersonnel>25
...
ttest logcrimerate if numpersonnel>25, by(post) unequal



ttest logcrimerate if numpersonnel>25 & mission=="UNIFIL", by(post) unequal

ttest logcrimerate if numpersonnel>25 & mission=="MINURSO", by(post) unequal

ttest logcrimerate if numpersonnel>25 & mission=="MONUSCO", by(post) unequal

ttest logcrimerate if numpersonnel>25 & mission=="UNISFA", by(post) unequal

ttest logcrimerate if numpersonnel>25 & mission=="UNMISS", by(post) unequal


ttest logcrimerate if numpersonnel>25 & mission=="MINUSMA", by(post) unequal

ttest logcrimerate if numpersonnel>25 & mission=="MINUSCA", by(post) unequal

*victimrate

ttest logvictimrate if numpersonnel>25, by(post) unequal

ttest logvictimrate if numpersonnel>25 & mission=="UNIFIL", by(post) unequal

ttest logvictimrate if numpersonnel>25 & mission=="MINURSO", by(post) unequal

ttest logvictimrate if numpersonnel>25 & mission=="MONUSCO", by(post) unequal

ttest logvictimrate if numpersonnel>25 & mission=="UNISFA", by(post) unequal

ttest logvictimrate if numpersonnel>25 & mission=="UNMISS", by(post) unequal

ttest logvictimrate if numpersonnel>25 & mission=="MINUSMA", by(post) unequal

ttest logvictimrate if numpersonnel>25 & mission=="MINUSCA", by(post) unequal


*Criminalrate

ttest logcriminalrate if numpersonnel>25, by(post) unequal

ttest logcriminalrate if numpersonnel>25 & mission=="UNIFIL", by(post) unequal

ttest logcriminalrate if numpersonnel>25 & mission=="MINURSO", by(post) unequal

ttest logcriminalrate if numpersonnel>25 & mission=="MONUSCO", by(post) unequal

ttest logcriminalrate if numpersonnel>25 & mission=="UNISFA", by(post) unequal

ttest logcriminalrate if numpersonnel>25 & mission=="UNMISS", by(post) unequal

ttest logcriminalrate if numpersonnel>25 & mission=="MINUSMA", by(post) unequal

ttest logcriminalrate if numpersonnel>25 & mission=="MINUSCA", by(post) unequal
